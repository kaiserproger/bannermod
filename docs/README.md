...
- `BANNERMOD_TECHNICAL_DESIGN.md` - architecture, state model, authority model, invariants, and target end state.
- `STRATEGIC_ECONOMY_INTEGRATION.md` - VenaTerra-backed strategic economy and mine integration notes.
- `AI_MINECRAFT_UI_STYLE_GUIDE.md` - style rules for Minecraft-native GUI/HUD work.
...
- `BANNERMOD_ALMANAC.html` - compact player-facing almanac derived from the guides and current runtime state.
