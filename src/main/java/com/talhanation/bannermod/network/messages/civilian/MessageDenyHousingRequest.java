...
public class MessageDenyHousingRequest implements BannerModMessage<MessageDenyHousingRequest> {
    private UUID householdId;

    public MessageDenyHousingRequest() {
    }

    public MessageDenyHousingRequest(UUID householdId) {
    ...
    public void executeServerSide(BannerModNetworkContext context) {
        context.enqueueWork(() -> {
            ...
            if (request.status() == NpcHousingRequestStatus.APPROVED) {
                MessageRequestHousingSnapshot.sendSystemMessage(player, Component.translatable("gui.bannermod.society.housing_request.command.approved_locked"));
                MessageRequestHousingSnapshot.sendSnapshot(player, MessageRequestHousingSnapshot.buildSnapshot(player));
                return;
            }
            ...
            NpcHousingRequestRecord updated = NpcHousingRequestAccess.denyHousehold(level, this.householdId, level.getGameTime());
            ...
            MessageRequestHousingSnapshot.sendSystemMessage(player, Component.translatable(
                    "gui.bannermod.society.housing_request.command.denied",
    ...
    @Override
    public MessageDenyHousingRequest fromBytes(FriendlyByteBuf buf) {
