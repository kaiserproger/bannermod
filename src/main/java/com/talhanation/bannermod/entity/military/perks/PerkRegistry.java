...
public final class PerkRegistry {
    ...
    private static List<PerkNode> defaultNodes() {
        return List.of(
                ...
                PerkNode.leaf("player/toughness_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.MAX_HEALTH, 2.0D)),
                PerkNode.leaf("player/iron_skin_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.KNOCKBACK_RESIST, 0.05D)),
                PerkNode.leaf("player/weapon_training_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.ATTACK_DAMAGE, 0.25D)),
                PerkNode.leaf("player/quick_hands_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.ATTACK_SPEED, 0.10D)),
                PerkNode.leaf("player/marching_drill_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.MOVEMENT_SPEED, 0.01D)),
                PerkNode.leaf("player/steady_aim_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.RANGED_ACCURACY, 0.05D)),
                PerkNode.leaf("player/strong_draw_i", PerkArchetype.UNIVERSAL, 1,
                        new PerkBonus(PerkStat.RANGED_VELOCITY, 0.05D)),
