...
public final class SettlementSeaTradeAnalyzer {
    ...
    public static List<BannerModSettlementDesiredGoodSeed> desiredGoods(BannerModSeaTradeSummary.Summary seaTradeSummary) {
        ...
        for (Map.Entry<ResourceLocation, Integer> entry : seaTradeSummary.importableByItem().entrySet()) {
            desiredGoods.add(new BannerModSettlementDesiredGoodSeed("sea_import:" + entry.getKey(), entry.getValue()));
        }
        for (Map.Entry<ResourceLocation, Integer> entry : seaTradeSummary.exportableByItem().entrySet()) {
            desiredGoods.add(new BannerModSettlementDesiredGoodSeed("sea_export:" + entry.getKey(), entry.getValue()));
        }
        return desiredGoods;
    }
